...
function Library(props){
  ...
  let createPlaylist = () => {
      ...
      props.dispatch({type: "CREATE-NEW-PLAYLIST", newLibraryName, newLibraryImg})
      setIsOpen(false);
  }
    ...
    return(
      <div>      
        <div className={styles.Libraries}>
          ...
          {isOpen && <Modal 
          newLibraryElementName={<input ref={newLibraryElementName} maxLength={14} type="text" placeholder="List name"></input>}
          newLibraryElementImg={<input ref={newLibraryElementImg} maxLength={100} type="text" placeholder="List imge URL"></input>}  
