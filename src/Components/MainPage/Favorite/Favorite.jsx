    ...
    return  <>
            {visibleList&&
              <li className={styles.Band}>
                <img id='object-position' className={styles.Icon} alt="" src={props.Img}/>
  ...
  let createFavoriteBand=()=>{
    ...
    return (
        <div className={styles.Favorite}>
            ...
            {isOpen && <Modal
            newFavoriteBandImageURL={<input ref={newFavoriteBandImageURL} maxLength={200} type="text" placeholder="Image URL"></input>}  
