    ...
    return  <>{visibleList&&
            <li className={styles.Playlist}>
                ...
                <Link href="" className = {styles.link}>
                    <Sprite onClick={remove} fill="white" stroke = "white" className={styles.Remove}/>
                </Link>
            </li>}
        </> 
  }
...
function Recommended(props) {
    ...
    let createRecommended=()=>{
            ...
            props.dispatch({type:"CREATE-NEW-RECOMMENDED", newRecommendedName, newRecommendedImage});
            setIsOpen(false);
        }
    ...
    return (
        <div className={styles.Recommended}>
            ...
            {isOpen && <Modal 
            newRecommendedNameText={<input ref={newRecommendedNameText} maxLength={14} type="text" placeholder="List name"></input>}
            newRecommendedImageURL={<input ref={newRecommendedImageURL} maxLength={200} type="text" placeholder="Recommended imge URL"></input>}  
